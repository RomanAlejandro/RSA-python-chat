...
mi_user = input("\n- - (*) ¿CUAL ES TU NOMBRE? : ")
conn.send(str.encode(mi_user))
print("\n- - LA OTRA PERSONA ESTA ESPERANDO A QUE PONGAMOS NUESTRO NOMBRE . . .")
#recivimos el usuario emisor
user_persona2 = conn.recv(HEADER2)
...
while True:
    ...
    print(" ----------------------------------------")
    print("(-)",user_persona2.decode()," : ", mensaje.decode())
    print(""" ----------------------------------------
        \   ^__^
         \  (oo)\_______
            (__)\       )\/\
...
# MANDA CONTESTA
    ...
    if (respuesta == "bye") or (respuesta == "adios") or (respuesta == "chau"):
            print("""
