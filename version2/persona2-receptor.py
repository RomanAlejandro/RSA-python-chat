...
""")
    ...
    print("SERVIDOR\nSE ESTABLECIDO EXITOSAMENTE\n")
    
    #enviamos nuestro usuario
    mi_user = input("\n- - (*) ¿CUAL ES TU NOMBRE? : ")
    TCPCliente.send(str.encode(mi_user))
    print("\n- - LA OTRA PERSONA ESTA ESCRIBIENDO SU NOMBRE ESPEREMOS,\n PARA DESPUES MANDAR NUESTRA LLAVE PUBLICA")
    
    #recibimos el usuario de la otra persona
    user_persona2 = TCPCliente.recv(HEADER2)
    print("- - CONTINUA POR FAVOR.")
    print("\n- - (*) ELEGIMOS VALORES DE NUMEROS PRIMOS PARA (p) y (q) ")
    lista_primos=genera_primos(150)
...
""")
        ...
        print(" ----------------------------------------")
        respuesta = "[+] "+user_persona2.decode()+" : " + mensaje[0].decode()
        print(respuesta)
        print(""" ----------------------------------------
        \   ^__^
         \  (oo)\_______
...
░░░░╚██████╚██░░╚███╚███████  ╚███████╚██░░╚██╚████████
 """)
            ...
            #output = ascii_magic.from_image_file('pato.jpg',colums = 50, char="#")
